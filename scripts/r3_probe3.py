...
rung-1 cells. Writes analysis/phase5/r3_probe3.{json,md}."""
...
write_json_atomic(
    root / "analysis/phase5/r3_probe3.json",
    {"variants": variants, "summary": summary, "instances": rows},
)
md = [
    "### R3 probe 3 — straight-through with larger steps (init 6, lr 0.2, 80 steps, best-of-trajectory)",
    "",
...
(root / "analysis/phase5/r3_probe3.md").write_text("\n".join(md))
print("\n".join(md))
